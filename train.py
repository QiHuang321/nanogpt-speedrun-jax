...
class Config:
    ...
    adam_nonmat_base_lr: float = 0.05333333333333333  # handicap
...
def init_params(config: Config, mesh: Mesh) -> PyTree:
    ...
    # Tied weights: lm_head shares the token embedding matrix (used transposed
    # in gpt_forward), so there is no separate lm_head parameter to allocate.
