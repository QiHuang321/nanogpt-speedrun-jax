...
def init_params(config: Config, mesh: Mesh) -> PyTree:
    ...
    # projection reuses params["wte"].T in gpt_forward, so no separate weight
    # is allocated here. The adam_lm_head optimizer then simply has no params
    # (multi_optimizer skips optimizers whose parameter subset is empty).
