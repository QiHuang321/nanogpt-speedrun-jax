...
class Config:
    ...
    # Warmup-stable-decay (trapezoid) LR schedule: linear warmup to peak,
    # constant plateau at peak (multiplier 1.0, so peak LR is unchanged),
    # then linear decay over the final fraction of training.
