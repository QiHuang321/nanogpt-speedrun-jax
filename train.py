...
def muon(
    ...
    def update(grads, params, state):
        ...
        # Adaptive Newton-Schulz: use fewer iterations early in training and
        # ramp up to the full count by the end. Early gradients are noisy, so a
        # coarser (cheaper) orthogonalization is sufficient; later steps get the
        # sharper full iteration count.
