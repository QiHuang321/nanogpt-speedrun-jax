...
def get_lr(it, n_warmup_iters, n_warmdown_iters, n_train_iters):
    # Warmup-stable-decay (trapezoid) learning-rate schedule. The peak
    # multiplier is 1.0, so the peak LR (base_lr * 1.0) is unchanged:
    #   warmup: linear ramp 0 -> 1 over the first n_warmup_iters steps
    #   stable: held flat at the peak of 1.0
