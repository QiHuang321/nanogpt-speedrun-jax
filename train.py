...
def init_params(config: Config, mesh: Mesh) -> PyTree:
    ...
    # in gpt_forward, so there is no separate lm_head parameter. The
    # adam_lm_head optimizer therefore receives an empty param subset and
    # no-ops; gradients to wte accumulate from both the embedding and the
    # output-projection paths automatically.
