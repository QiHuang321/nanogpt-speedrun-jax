...
class Config:
    ...
    # first n_warmup_iters steps (default 100), then a stable phase held at the
    # peak LR, then linear decay to ~0 over the final f_warmdown_iters fraction.
    # n_warmdown_iters is derived from its fraction in __post_init__; n_warmup_iters
    # falls back to the f_warmup_iters fraction only if left at 0.
