...
def init_params(config: Config, mesh: Mesh) -> PyTree:
    ...
    # Tied weights: the lm_head shares the token embedding (wte) matrix; the
    # output projection uses wte.T in gpt_forward, so there is no separate
    # lm_head parameter to initialize here.
