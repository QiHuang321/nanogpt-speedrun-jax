...
class Config:
    ...
    # Warmup-stable-decay (trapezoid) LR schedule: linear warmup, a flat stable
    # plateau at peak LR, then a linear decay leg over the final fraction of
    # training. Peak LR is unchanged (get_lr() plateaus at 1.0 ⟹ base_lr).
