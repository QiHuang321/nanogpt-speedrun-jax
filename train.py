...
def init_params(config: Config, mesh: Mesh) -> PyTree:
    ...
    # wte^T (see gpt_forward) instead of holding a separate parameter, so
    # gradients from both the input lookup and the output logits accumulate
    # into the single shared `wte` weight.
