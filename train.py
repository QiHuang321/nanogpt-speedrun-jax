...
class Config:
    ...
    muon_ns_iters_init: int = 1  # adaptive: fewer Newton-Schulz iters early, ramping to muon_ns_iters
    muon_eps: float = 1e-7
...
def muon(
    ...
    def update(grads, params, state):
        ...
        # Adaptive Newton-Schulz iteration count: ramp linearly from ns_iters_init
        # early in training up to the full ns_iters by the end (fewer iters early).
