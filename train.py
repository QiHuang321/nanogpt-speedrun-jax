...
def init_params(config: Config, mesh: Mesh) -> PyTree:
    ...
    # Tied weights: the lm_head shares the token embedding (wte) matrix, so no
    # separate lm_head parameter is allocated. The output projection uses
    # wte.T in gpt_forward.
