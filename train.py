...
def get_lr(it, n_warmup_iters, n_warmdown_iters, n_train_iters):
    ...
    # applied to each optimizer's base (peak) LR, so the peak is left unchanged:
    #   - warmup: linear ramp 0 -> 1 over n_warmup_iters steps
    #   - stable: held at the peak (1.0) through the plateau
