...
class Config:
    ...
    adam_nonmat_base_lr: float = 0.026667
...
def init_params(config: Config, mesh: Mesh) -> PyTree:
    ...
    # separate output-projection parameter is allocated. Gradients from both
    # the embedding lookup and the output projection accumulate into wte.
