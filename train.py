...
def get_lr(it, n_warmup_iters, n_warmdown_iters, n_train_iters):
    # Warmup-stable-decay (trapezoid) schedule: linear warmup from 0 -> 1, a
    # stable plateau at the (unchanged) peak of 1.0, then a linear decay from
    # 1 -> 0 over the final n_warmdown_iters steps.
