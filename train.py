...
def get_lr(it, n_warmup_iters, n_warmdown_iters, n_train_iters):
    ...
    # peak (base) LR. The multiplier ramps linearly 0 -> 1 over the warmup
    # window, holds flat at the peak value of 1.0 through the stable phase, then
    # ramps linearly 1 -> 0 over the final warmdown window. Peak LR is unchanged.
