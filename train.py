...
class Config:
    ...
    muon_ns_iters_init: int = 1  # fewer Newton-Schulz iters early; ramps to muon_ns_iters
    muon_eps: float = 1e-7
...
def muon(
    ...
    def update(grads, params, state):
        ...
        # Adaptive Newton-Schulz iteration count: fewer early, ramping linearly
        # from ns_iters_init to ns_iters over the course of training.
