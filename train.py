...
class Config:
    ...
    # Warmup-stable-decay (WSD / trapezoid) schedule. Peak LR is unchanged
    # (the stable phase holds get_lr at multiplier 1.0, i.e. base_lr): the LR
    # ramps up over the first n_warmup_iters, stays flat at the peak, then
    # linearly decays over the final f_warmdown_iters fraction of training.
