...
def get_lr(it, n_warmup_iters, n_warmdown_iters, n_train_iters):
    ...
    # sits at 1.0 (peak LR = base_lr, unchanged):
    ...
    # jnp.maximum guards the denominators (n_warmup_iters defaults to 0); the
    # guarded branches are masked out by the wheres so selected values are exact.
