...
class Config:
    ...
    # warmup-stable-decay (trapezoid) schedule: linear warmup up to the peak LR,
    # a stable phase at the (unchanged) peak, then a linear decay over the final
    # f_warmdown_iters fraction of training. See get_lr below.
